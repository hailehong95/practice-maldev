...
**		B1: Solution Explorer > Resource view > Project name > Add > Resource > Import >
**			> Chọn tệp cần import (Đặt type là BIN) > Sau khi import sẽ tự sinh ra file: *.h, *.rc và tệp vừa import
**			Làm tương tự với thao tác import file ảnh PNG
...
**			VD: IDR_BIN1, IDB_PNG1 và định nghĩa bên trong "resource.h": #define IDR_BIN1 101; #define IDB_PNG1 102
